...
export default function AppHeader({ 
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#D4F1E8] border-b border-black/10 shadow-xs font-sans">
      {/* Main Bar */}
        ...
        <div className="flex items-center gap-2.5 relative">
          ...
          <div className="relative shrink-0">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold border border-slate-700 transition-colors shadow-xs"
            >
          ...
          {currentUser && (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 p-1 pr-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-white text-xs transition-colors shadow-xs"
              >
                <img
